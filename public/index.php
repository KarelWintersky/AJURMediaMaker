...
/*$upload_limits = [
    'POST_MAX_SIZE'     =>  Common::get_ini_value('post_max_size'),
    'UPLOAD_MAX_SIZE'   =>  Common::get_ini_value('upload_max_filesize'),
    'CONFIG_MAX_SIZE'   =>  Common::return_bytes(_env('MAX_UPLOAD_SIZE', '64M')),
];
$upload_limits['REAL_MAX_SIZE'] = min(
    $upload_limits['POST_MAX_SIZE'],
    $upload_limits['UPLOAD_MAX_SIZE'],
    $upload_limits['CONFIG_MAX_SIZE']
);*/
...
<head>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $(`button[type="reset"]`).addEventListener('click', resetHandler);
